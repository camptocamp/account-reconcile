...
Feature: Configure the deliveries
  ...
  Given I need a "delivery.carrier" with oid: <oid>
    ...
    Examples: carrier
      ...
      | scenario.carrier_pl_vino3         | PostLogistics CH : VinoLog - 3 bouteilles | by oid: scenario.partner_postlogistics    | 34      | 1      |
      | scenario.carrier_pl_alcool        | PostLogistics CH : PostAlcool             | by oid: scenario.partner_postlogistics    | 45      | 1      |
      | scenario.carrier_pl_big_spec49    | PostLogistics CH : Big Special 49         | by oid: scenario.partner_postlogistics    | 36      | 1      |
      | scenario.carrier_pl_light699      | PostLogistics CH : Light 699              | by oid: scenario.partner_postlogistics    | 24      | 1      |
      | scenario.carrier_pl_light_weight  | PostLogistics CH : Light Weight           | by oid: scenario.partner_postlogistics    | 16      | 1      |
      | scenario.carrier_pl_large         | PostLogistics CH : Large                  | by oid: scenario.partner_postlogistics    | 15      | 1      |
      | scenario.carrier_pl_vino_basic    | PostLogistics CH : VinoLog - Basic        | by oid: scenario.partner_postlogistics    | 22      | 1      |
      | scenario.carrier_pl_basic         | PostLogistics CH : Basic                  | by oid: scenario.partner_postlogistics    | 1       | 1      |
      | scenario.carrier_pl_vino_1_12     | PostLogistics CH : VinoLog 1/12           | by oid: scenario.partner_postlogistics    | 44      | 1      |
      | scenario.carrier_pl_advanced      | PostLogistics CH : Advanced               | by oid: scenario.partner_postlogistics    | 4       | 1      |
      | scenario.carrier_pl_big           | PostLogistics CH : Big                    | by oid: scenario.partner_postlogistics    | 3       | 1      |
      | scenario.carrier_pl_medium        | PostLogistics CH : Medium                 | by oid: scenario.partner_postlogistics    | 2       | 1      |
