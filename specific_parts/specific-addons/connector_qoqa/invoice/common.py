...
class account_invoice(orm.Model):
    ...
    def _prepare_refund(self, cr, uid, invoice, date=None, period_id=None,
        ...
        ## We need to set the account_id of the payment mode in order to make the reconciliation
        ## with the refund done with the bank 
        ...
        if sales: 
            ...
            if sale.qoqa_bind_ids:
                ...
                if sale.payment_method_id:
                    if sale.payment_method_id.journal_id:
                        result['account_id'] = sale.payment_method_id.journal_id.default_credit_account_id.id
        return result
